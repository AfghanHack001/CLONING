...
if not os.path.isfile('.agents.txt'):
    os.system('curl -L https://raw.githubusercontent.com/AfghanHack001/uagent/main/.agents.txt > .agents.txt')
ct = datetime.now()
n = ct.month
...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 9; SM-G950U Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/107.0.5304.105 Mobile Safari/537.36 GoogleApp/13.44.10.26.arm64;]"}
...
def main():
    ...
    print('\033[1;92m│\033[1;37m[07] \033[1;96REMOVE TOKEN\033[1;32m                           │')
...
banner = """
  ...
  __  __ _____    ______ _  __     __       _____ 
 |  \/  |  __ \  |  ____| | \ \   / //\    / ____|
 | \  / | |__) | | |__  | |  \ \_/ //  \  | (___  
 | |\/| |  _  /  |  __| | |   \   // /\ \  \___ \ 
 | |  | | | \ \ _| |____| |____| |/ ____ \ ____) |
 |_|  |_|_|  \_(_)______|______|_/_/    \_\_____/ 
...
\033[1;32m└────────────────────────────────────────────────┘
\033[1;32m│         \033[1;37m•  THIS TOOL IS FREE ENJOY \033[1;37m•      \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
"""
ct = datetime.now()
n = ct.month
